...
class Staff(models.Model):
    ...
    image = models.ImageField(upload_to='staff', verbose_name='プロフィール画像', null=True, blank=True)
    tel = models.CharField('電話番号', max_length=100, null=True, blank=True)
    address = models.CharField(('住所'), max_length=100, null=True, blank=True)
...
class News(models.Model):
    ...
    image = models.ImageField(upload_to='news', verbose_name='画像', null=True, blank=True)
...
class Style(models.Model):
    ...
    image = models.ImageField(upload_to='style', verbose_name='画像', null=True, blank=True)
