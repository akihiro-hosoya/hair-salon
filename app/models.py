...
class Staff(models.Model):
    ...
    image = models.ImageField(upload_to='img', verbose_name='プロフィール画像', null=True, blank=True)
    tel = models.CharField('電話番号', max_length=100, null=True, blank=True)
    address = models.CharField(('住所'), max_length=100, null=True, blank=True)
...
class News(models.Model):
    ...
    image = models.ImageField(upload_to='img', verbose_name='画像', null=True, blank=True)
